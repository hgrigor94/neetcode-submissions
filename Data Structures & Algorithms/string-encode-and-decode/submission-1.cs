public class Solution {
    ...
    public string Encode(IList<string> strs)
    {
        ...
        var builder = new StringBuilder(204 * strs.Count);
    ...
    public List<string> Decode(string s)
    {
        ...
        var strList = new List<string>(s.Length * 200);
        ...
        while(i < s.Length - 1)
        {
            ...
            //Console.WriteLine($"i: {i},\tcontrolLength: {controlLength},\twordLength: {wordLength}");
